...
// Obtener estadísticas completas de un proyecto
  getProyectoCompleto: async (idProyecto) => {
    try {
      const res = await api.get(`/auth/reportes/proyecto/${idProyecto}/completo`);
      return res.data;
    } catch (error) {
      throw errorHandler(error);
    }
  ...
  // Obtener estadísticas completas de un programa
  getProgramaCompleto: async (idPrograma) => {
    try {
      const res = await api.get(`/auth/reportes/programa/${idPrograma}/completo`);
      return res.data;
    } catch (error) {
      throw errorHandler(error);
    }
  ...
  getPortafolioCompleto: async (idPortafolio) => {
    try {
      const res = await api.get(`/auth/reportes/portafolio/${idPortafolio}/completo`);
      return res.data;
    } catch (error) {
      throw errorHandler(error);
    }
  ...
  getEstadisticasGlobalesReales: async () => {
    try {
      const res = await api.get('/auth/reportes/estadisticas-globales-reales');
      return res.data;
    } catch (error) {
      throw errorHandler(error);
    }
