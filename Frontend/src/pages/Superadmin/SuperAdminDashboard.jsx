...
import CoordinatorsManager from "./CoordinatorsManager";
      ...
      <main className="admin-main">
        {vista === "bienvenida" && (
          <div className="dashboard-content">
            ...
            {/* Stats Grid - Actualizado con coordinadores */}
            <div className="stats-grid">
              ...
              <div className="stat-card info">
                <div className="stat-icon">👨‍🏫</div>
                <div className="stat-content">
                  <div className="stat-number">{stats.totalCoordinadores}</div>
            ...
            {/* Mensaje de bienvenida para superadmin */}
        ...
        {vista === "coordinadores" && <CoordinatorsManager />}
      </main>
    </div>
  );
}